...
import de.dali.demonstrator.ui.base.custom.FingerPrintListAdapter.FingerPrintViewHolder
    ...
    override fun onBindViewHolder(holder: FingerPrintViewHolder, position: Int) {
        list?.let {
            ...
            holder.txtRecordSet.text =
                holder.itemView.context.getString(R.string.fragment_selection_record_set, (position + 1).toString())
